...
function addMenuItems(entreeContainer, mainContainer, desertContainer) {
    menu.forEach((item) => {
        ...
        switch (item.type) {
            case "entree":
                entreeContainer.appendChild(name);
                entreeContainer.appendChild(description);
                entreeContainer.appendChild(price);
                break;
            ...
            case "desert":
                desertContainer.appendChild(name);
                desertContainer.appendChild(description);
                desertContainer.appendChild(price);
        }
    })
}
